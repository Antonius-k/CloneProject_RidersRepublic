...
namespace YDWScripts
{
    public class SuspensionManagerYDW : MonoBehaviourPun
    {
        public bool enable;
        ...
        BicycleControllerYDW bicycleController;
        ...
        void Start()
        {
            ...
            bicycleController = FindObjectOfType<BicycleControllerYDW>();
            //Suspension Settings
            if (enable)
            {
                if (fSuspension != null)
